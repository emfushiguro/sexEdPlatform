            ...
            <form method="POST" action="{{ route('admin.subscription-plans.store') }}" x-data="planForm()">
                ...
                <div class="mb-5">
                    ...
                    <textarea name="description" rows="3"
                              class="w-full px-3 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-transparent text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500/30 resize-none">{{ old('description') }}</textarea>
                </div>
