...
<div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5 mb-8">
        ...
        <div class="rounded-2xl bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-gray-800 shadow-theme-xs p-6">
            <div class="flex items-center gap-3">
                <span class="w-10 h-10 rounded-full bg-brand-50 dark:bg-brand-500/10 flex items-center justify-center">
                ...
                <div>
                    <p class="text-xs font-semibold text-gray-400 dark:text-gray-500">Total Subscribers</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $subscriptionStats['total'] ?? 0 }}</p>
                </div>
            </div>
        </div>
        <div class="rounded-2xl bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-gray-800 shadow-theme-xs p-6">
            <div class="flex items-center gap-3">
                <span class="w-10 h-10 rounded-full bg-success-50 dark:bg-success-500/10 flex items-center justify-center">
                ...
                <div>
                    <p class="text-xs font-semibold text-gray-400 dark:text-gray-500">Active</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $subscriptionStats['active'] ?? 0 }}</p>
                </div>
            </div>
        </div>
        <!-- Plan Stats -->
        <div class="rounded-2xl bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-gray-800 shadow-theme-xs p-6">
            <div class="flex items-center gap-3">
                <span class="w-10 h-10 rounded-full bg-indigo-50 dark:bg-indigo-500/10 flex items-center justify-center">
                ...
                <div>
                    <p class="text-xs font-semibold text-gray-400 dark:text-gray-500">Total Plans</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $planStats['total'] ?? 0 }}</p>
                </div>
            </div>
        </div>
        <div class="rounded-2xl bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-gray-800 shadow-theme-xs p-6">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs font-semibold text-gray-400 dark:text-gray-500">Active Plans</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $planStats['active'] ?? 0 }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-2xl bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-gray-800 shadow-theme-xs p-6">
            <div class="flex items-center gap-3">
                <span class="w-10 h-10 rounded-full bg-warning-50 dark:bg-warning-500/10 flex items-center justify-center">
                ...
                <div>
                    <p class="text-xs font-semibold text-gray-400 dark:text-gray-500">Expiring Soon</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $subscriptionStats['expiring_soon'] }}</p>
                </div>
            </div>
        </div>
        @endif
    ...
    <form method="GET" action="" class="mb-6 flex flex-wrap gap-4 items-end">
        <div>
            ...
            <select name="status" id="status" class="rounded-lg border-gray-300 dark:bg-gray-800 dark:text-white text-sm">
        ...
        <div>
            ...
            <select name="plan_id" id="plan_id" class="rounded-lg border-gray-300 dark:bg-gray-800 dark:text-white text-sm">
                <option value="">All</option>
        ...
        <div>
            ...
            <input type="text" name="search" id="search" value="{{ request('search') }}" placeholder="Name or Email" class="rounded-lg border-gray-300 dark:bg-gray-800 dark:text-white text-sm" />
        </div>
        <div>
