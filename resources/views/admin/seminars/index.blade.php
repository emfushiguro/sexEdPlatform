...
<div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
    @foreach([['label'=>'Total Seminars','value'=>'24','bg'=>'bg-brand-50 dark:bg-brand-500/10','color'=>'text-brand-600 dark:text-brand-400'],['label'=>'Upcoming','value'=>'8','bg'=>'bg-warning-50 dark:bg-warning-500/10','color'=>'text-warning-600 dark:text-warning-400'],['label'=>'Completed','value'=>'14','bg'=>'bg-success-50 dark:bg-success-500/10','color'=>'text-success-600 dark:text-success-400'],['label'=>'Registrations','value'=>'342','bg'=>'bg-purple-50 dark:bg-purple-500/10','color'=>'text-purple-600 dark:text-purple-400']] as $c)
...
<div class="rounded-2xl bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-gray-800 shadow-theme-xs overflow-hidden">
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 px-6 py-4 border-b border-gray-100 dark:border-gray-800">
        <h3 class="text-base font-semibold text-gray-900 dark:text-white">All Seminars</h3>
    ...
    <div class="px-6 py-3 border-b border-gray-100 dark:border-gray-800">
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <input type="text" placeholder="Search seminars..." class="px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-transparent text-sm text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500/30 focus:border-brand-500 transition">
            <select class="px-3 py-2 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 text-sm text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-brand-500/30">
        ...
        <table class="min-w-full divide-y divide-gray-100 dark:divide-gray-800">
            <thead class="bg-gray-50 dark:bg-white/[0.02]">
                <tr>
                    ...
                    <th class="px-5 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Date & Time</th>
                    <th class="px-5 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Type</th>
                    <th class="px-5 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Presenter</th>
                    <th class="px-5 py-3 text-left text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider">Capacity</th>
            ...
            <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                @php
                    ...
                    $typeMap = ['Online'=>'bg-brand-50 text-brand-700 dark:bg-brand-500/10 dark:text-brand-400','In-Person'=>'bg-success-50 text-success-700 dark:bg-success-500/10 dark:text-success-400','Hybrid'=>'bg-purple-50 text-purple-700 dark:bg-purple-500/10 dark:text-purple-400'];
                    $stMap = ['upcoming'=>'bg-warning-50 text-warning-700 dark:bg-warning-500/10 dark:text-warning-400','ongoing'=>'bg-success-50 text-success-700 dark:bg-success-500/10 dark:text-success-400','completed'=>'bg-gray-100 text-gray-500 dark:bg-white/5 dark:text-gray-400','cancelled'=>'bg-error-50 text-error-700 dark:bg-error-500/10 dark:text-error-400'];
                @endphp
                @foreach($mock as $s)
                <tr class="hover:bg-gray-50 dark:hover:bg-white/[0.02] transition-colors">
                    <td class="px-5 py-3"><p class="text-sm font-semibold text-gray-900 dark:text-white">{{ $s['title'] }}</p></td>
                    <td class="px-5 py-3 text-sm text-gray-500 dark:text-gray-400">{{ $s['date'] }}</td>
                    ...
                    <td class="px-5 py-3 text-sm text-gray-700 dark:text-gray-300">{{ $s['presenter'] }}</td>
                    <td class="px-5 py-3 text-sm text-gray-500 dark:text-gray-400">{{ $s['cap'] }}</td>
                    ...
                    <td class="px-5 py-3 text-right">
                        <a href="{{ route('admin.seminars.show', 1) }}" class="p-1.5 rounded-lg text-gray-400 hover:bg-brand-50 hover:text-brand-600 dark:hover:bg-brand-500/10 dark:hover:text-brand-400 transition-colors inline-flex">
