                        ...
                        <div class="mb-4">
                            ...
                            <div class="space-y-3">
                                <label class="flex items-start">
                                    <input type="radio" name="publish_type" value="draft" {{ old('publish_type', 'draft') === 'draft' ? 'checked' : '' }}
                                ...
                                <label class="flex items-start">
                                    <input type="radio" name="publish_type" value="publish_now" {{ old('publish_type') === 'publish_now' ? 'checked' : '' }}
                                        class="mt-1 rounded-full border-gray-300 text-blue-600 focus:ring-blue-500"
                                        onchange="toggleScheduleFields()">
                                    <div class="ml-3">
                                ...
                                <label class="flex items-start">
                                    <input type="radio" name="publish_type" value="schedule" {{ old('publish_type') === 'schedule' ? 'checked' : '' }}
                                        class="mt-1 rounded-full border-gray-300 text-blue-600 focus:ring-blue-500"
                                        onchange="toggleScheduleFields()">
                                    <div class="ml-3">
                                ...
                                <div id="schedule_fields" class="ml-6 mt-3 {{ old('publish_type') === 'schedule' ? '' : 'hidden' }}">
