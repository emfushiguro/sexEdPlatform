    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <a href="{{ route('admin.lessons.create', ['module_id' => $module->id]) }}" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
                    Add Lesson
                </a>
                <a href="{{ route('admin.modules.edit', $module) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded">
                    Edit Module
                </a>
                <a href="{{ route('admin.modules.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded">
                    Back to List
                </a>
            </div>
        </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="{{ route('admin.lessons.create', ['module_id' => $module->id]) }}" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded">
                            + Add Lesson
                        </a>
                    </div>
                                ...
                                <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50 transition" draggable="true">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <!-- Move Up/Down -->
                                            @if(!$loop->first)
                                                <form action="{{ route('admin.lessons.move', $lesson) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('PATCH')
                    ...
                    @else
                        <div class="text-center py-12 text-gray-500">
                            ...
                            <a href="{{ route('admin.lessons.create', ['module_id' => $module->id]) }}" class="mt-4 inline-block bg-blue-600 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded">
                                Create First Lesson
                            </a>
                        </div>
                    @endif
