...
<body>
    ...
    <h1>{{ ucfirst($filter->reportType) }} Financial Report</h1>
    <div class="meta">
    ...
    <table class="summary-grid">
        <tr><td>Total Revenue</td><td>₱{{ number_format((float) ($summary['total_revenue'] ?? 0), 2) }}</td></tr>
        <tr><td>Subscription Revenue</td><td>₱{{ number_format((float) ($summary['subscription_revenue'] ?? 0), 2) }}</td></tr>
        <tr><td>Module Revenue</td><td>₱{{ number_format((float) ($summary['module_revenue'] ?? 0), 2) }}</td></tr>
        <tr><td>Platform Earnings</td><td>₱{{ number_format((float) ($summary['platform_earnings'] ?? 0), 2) }}</td></tr>
