...
<div class="px-4 py-8 mx-auto space-y-6 max-w-7xl">
    ...
    <section class="grid grid-cols-1 gap-6 xl:grid-cols-12">
        <div class="space-y-6 xl:col-span-8">
            <article class="overflow-hidden bg-white border rounded-2xl border-brand-200/80 shadow-soft ring-1 ring-brand-200/30 dark:border-slate-700/70 dark:bg-slate-900 dark:ring-slate-700/30">
                <div class="px-6 py-5 border-b border-brand-100 bg-gradient-to-r from-brand-50/70 via-white to-white dark:border-slate-800 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900">
                ...
                <div class="grid gap-6 px-6 py-6 lg:grid-cols-5">
                    ...
                    <div class="space-y-4 lg:col-span-2">
                        @foreach($learnerDemographics as $group)
                            ...
                            @endphp
                            <div class="p-4 rounded-xl bg-gradient-to-br from-brand-50/80 via-white to-white ring-1 ring-brand-100/70 dark:bg-slate-800/60 dark:ring-slate-700/60">
                                ...
                                <div class="h-2 mt-3 rounded-full bg-brand-100/60 dark:bg-slate-700">
        ...
        <div class="space-y-6 xl:col-span-4">
            <article class="overflow-hidden bg-white border rounded-2xl border-brand-200/80 shadow-soft ring-1 ring-brand-200/30 dark:border-slate-700/70 dark:bg-slate-900 dark:ring-slate-700/30">
                ...
                <div class="px-6 py-6 space-y-3">
                    @foreach($moderationQueues as $queue)
                        <div class="flex items-center justify-between px-4 py-3 rounded-xl bg-gradient-to-br from-brand-50/80 via-white to-white ring-1 ring-brand-100/70 dark:bg-slate-800/60 dark:ring-slate-700/60">
                            <div>
            ...
            <article class="overflow-hidden bg-white border rounded-2xl border-brand-200/80 shadow-soft ring-1 ring-brand-200/30 dark:border-slate-700/70 dark:bg-slate-900 dark:ring-slate-700/30">
                ...
                <div class="px-6 py-6 space-y-3">
                    <a href="{{ route('admin.users.index') }}" class="flex items-center justify-between px-4 py-3 transition border group rounded-xl border-slate-200 bg-slate-50/50 hover:border-brand-300 hover:bg-brand-50 dark:border-slate-700 dark:bg-slate-800/50 dark:hover:border-brand-500/50 dark:hover:bg-brand-500/10">
                        <div class="flex items-center gap-3">
                            <span class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-brand-100 text-brand-600 dark:bg-brand-500/20 dark:text-brand-300">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 transition text-slate-400 group-hover:translate-x-1 group-hover:text-brand-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
                    </a>
                    
                    <a href="{{ route('admin.payments.index') }}" class="flex items-center justify-between px-4 py-3 transition border group rounded-xl border-slate-200 bg-slate-50/50 hover:border-brand-300 hover:bg-brand-50 dark:border-slate-700 dark:bg-slate-800/50 dark:hover:border-brand-500/50 dark:hover:bg-brand-500/10">
                        <div class="flex items-center gap-3">
                            <span class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-brand-100 text-brand-600 dark:bg-brand-500/20 dark:text-brand-300">
                    ...
                    <a href="{{ route('admin.modules.index') }}" class="flex items-center justify-between px-4 py-3 transition border group rounded-xl border-slate-200 bg-slate-50/50 hover:border-brand-300 hover:bg-brand-50 dark:border-slate-700 dark:bg-slate-800/50 dark:hover:border-brand-500/50 dark:hover:bg-brand-500/10">
                        <div class="flex items-center gap-3">
                            <span class="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-brand-100 text-brand-600 dark:bg-brand-500/20 dark:text-brand-300">
    ...
    <section class="overflow-hidden bg-white border rounded-2xl border-brand-200/80 shadow-soft ring-1 ring-brand-200/30 dark:border-slate-700/70 dark:bg-slate-900 dark:ring-slate-700/30">
        <div class="px-6 py-5 border-b border-brand-100 bg-gradient-to-r from-brand-50/70 via-white to-white dark:border-slate-800 dark:from-slate-900 dark:via-slate-900 dark:to-slate-900">
            ...
            @forelse($recentActivity as $activity)
                <a href="{{ $activity['href'] }}" class="block px-6 py-4 transition hover:bg-brand-50/60 dark:hover:bg-slate-800/50">
                    <div class="flex items-start gap-4">
                        ...
                        <span class="text-xs whitespace-nowrap text-slate-400 dark:text-slate-500">{{ optional($activity['occurred_at'])->diffForHumans() }}</span>
                    </div>
                </a>
            @empty
                <div class="px-6 py-12 text-sm text-center text-slate-500 dark:text-slate-400">No recent system activity to display yet.</div>
            @endforelse
        </div> </section>
</div>
@endsection
