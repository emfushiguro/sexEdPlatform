<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('admin.quizzes.show', $quiz) }}" class="text-sm text-gray-600 hover:text-gray-900">
                ← Back to Quiz
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.quizzes.store-question', $quiz) }}" id="questionForm">
                        @csrf
