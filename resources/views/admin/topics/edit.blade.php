<x-app-layout>
    <x-slot name="header">
        <x-breadcrumb :items="[
            ...
            ['label' => $topic->lesson->title, 'url' => route('admin.lessons.show', $topic->lesson)],
            ['label' => 'Edit Topic']
        ]" />
        
        <div class="flex items-center space-x-3 mt-4">
            <a href="{{ route('admin.lessons.show', $topic->lesson) }}" class="text-gray-600 hover:text-gray-900">
    ...
    <!-- Form -->
    <form action="{{ route('admin.topics.update', $topic) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
        @csrf
        @method('PUT')
        ...
        <div class="flex items-center justify-end space-x-4">
            <a 
                href="{{ route('admin.lessons.show', $topic->lesson->id) }}" 
