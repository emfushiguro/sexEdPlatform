                    ...
                    <form method="POST" action="{{ route('admin.lessons.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="px-3 py-2 bg-gray-50 border border-gray-300 rounded-md text-sm text-gray-600">
                                Auto-calculated from topics
                            </div>
                            <p class="mt-1 text-xs text-gray-500">Duration will be automatically calculated based on topic durations</p>
                        </div>

                        <!-- Order (Read-only, auto-numbered) -->
                        <div class="mb-6">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Order</label>
                            <div class="px-3 py-2 bg-gray-50 border border-gray-300 rounded-md text-sm text-gray-600">
                                Auto-numbered
                            </div>
                            <p class="mt-1 text-xs text-gray-500">Order will be automatically assigned based on existing lessons</p>
                        </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-blue-700">
                                        <strong>Note:</strong> After creating this lesson, you'll be able to add topics (videos, texts, quizzes, etc.) from the lesson overview page.
                                    </p>
                                </div>
                            </div>
                        </div>
