<x-app-layout>
    <x-slot name="header">
        <x-breadcrumb :items="[
            ...
            ['label' => $lesson->module->title, 'url' => route('admin.modules.show', $lesson->module)],
            ['label' => 'Edit Lesson']
        ]" />
                    ...
                    <form method="POST" action="{{ route('admin.lessons.update', $lesson) }}">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="px-3 py-2 bg-gray-50 border border-gray-300 rounded-md text-sm text-gray-600">
                                {{ $lesson->topics()->sum('duration') ?? 0 }} minutes (auto-calculated from topics)
                            </div>
                            <p class="mt-1 text-xs text-gray-500">Duration is automatically calculated based on topic durations</p>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-1 text-xs text-gray-500">Order is automatically assigned within the module</p>
                        </div>
