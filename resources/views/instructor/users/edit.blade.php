<x-app-layout>
    <x-slot name="header">
        <x-breadcrumb :items="[
            ...
            ['label' => 'Users', 'url' => route('instructor.users.index')],
            ['label' => 'Edit']
        ]" />
        
        <div class="flex items-center space-x-3 mt-4">
            <a href="{{ route('instructor.users.index') }}" class="text-gray-600 hover:text-gray-900">
                ...
                <div class="p-6">
                    <form method="POST" action="{{ route('instructor.users.update', $user) }}">
                        ...
                        <div class="flex items-center justify-end gap-4">
                            <a href="{{ route('instructor.users.index') }}" class="text-gray-600 hover:text-gray-900">Cancel</a>
