<x-app-layout>
    <x-slot name="header">
        ...
        <div class="flex justify-between items-center mt-4">
            ...
            <a href="{{ route('instructor.users.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                Create New User
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <form method="GET" action="{{ route('instructor.users.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div>
                        ...
                        <div class="flex gap-2">
                            ...
                            <a href="{{ route('instructor.users.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded">
                                Reset
                            </a>
                        </div>
                    </form>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        <a href="{{ route('instructor.users.show', $user) }}" class="inline-block px-3 py-1 bg-blue-600 text-white rounded hover:bg-blue-700 mr-2">View</a>
                                        <a href="{{ route('instructor.users.edit', $user) }}" class="inline-block px-3 py-1 bg-yellow-500 text-white rounded hover:bg-yellow-600 mr-2">Edit</a>
