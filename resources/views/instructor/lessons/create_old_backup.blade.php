    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('instructor.lessons.store') }}" enctype="multipart/form-data" id="lessonForm">
                        @csrf
                        ...
                        <div class="flex items-center justify-end gap-4 pt-6 border-t">
                            <a href="{{ route('instructor.lessons.index') }}" class="px-6 py-2 text-gray-700 hover:text-gray-900 border border-gray-300 rounded-lg">
                                Cancel
                            </a>
    ...
    <script>
        ...
        document.getElementById('lessonForm').addEventListener('submit', function(e) {
            ...
            if (isVideoUpload) {
                    ...
                    if (xhr.status === 200) {
                        try {
                            ...
                            if (response.success) {
                                ...
                                window.location.href = response.redirect || '{{ route("instructor.lessons.index") }}';
                            } else {
                ...
                xhr.open('POST', '{{ route("instructor.lessons.store") }}');
