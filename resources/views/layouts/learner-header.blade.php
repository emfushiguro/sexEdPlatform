    ...
    <div class="flex items-center justify-between h-16 px-4 md:px-6">
        ...
        <div class="flex items-center gap-2 sm:gap-3">
            ...
            <button
                ...
                class="flex h-10 w-10 items-center justify-center rounded-lg border transition-colors focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
